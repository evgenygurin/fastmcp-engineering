...
| Concern | Default decision | Verification |
|---|---|---|
...
6. Critical MCP tools require verification of the actual FastMCP-visible schema, not only the Python annotation.
7. Avoid accidental coercion for security-sensitive values.
8. Discriminated unions are preferred when variants have stable discriminators.
