# Acceptance — Telemetry Engineering

- [ ] Defines telemetry goals, signal ownership, and operational consumers.
- [ ] Covers logs, metrics, and traces only where they provide actionable evidence.
